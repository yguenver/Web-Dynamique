					...
					if(isset($_POST['Accueil']))
					{
						...
						//if($nbResult == 1){echo ' style="font-size: 50px;" ';}
							...
							*/
							...
							if(isset($_SESSION['login'])) {echo ' action="AjouterAuPanier.php?NomJeu='.$dataset["Jeu"].'" ><input type="submit" value="';
							}else {echo ' action="pageConnexion.php"';}
							if(isset($_SESSION['login'])){echo 'Ajouter au panier" name="'/*.$dataset["Jeu"]*/.'_AjoutPanier" />';
								}else {
